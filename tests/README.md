...
```bash
node tests/run.mjs                 # everything: 243 tests, about 25 seconds
...
|---|---|---|---|
| `unit/` | 121 | nothing | the logic: scheduling, one review sitting, storage, the usage log, the braces convention, the three quiz mechanics, the gauge |
...
| `e2e/` | 73 | Chromium | the app as a learner meets it: five screens, driven by tapping, and what the usage log records |
