...
```bash
node tests/run.mjs                 # everything: 309 tests, about 35 seconds
...
|---|---|---|---|
| `unit/` | 147 | nothing | the logic: scheduling, one review sitting, storage, the usage log, the braces convention, the three quiz mechanics, which cloze card is asked and what sits beside it, the gauge |
